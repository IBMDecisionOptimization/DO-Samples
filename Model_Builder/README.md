...
The `Cloud Pak for Data v5.4.x` directory contains `.zip` files for the samples that can be used with IBM Cloud Pak for Data V5.4.x.

The `Cloud Pak for Data v5.3.x` directory contains `.zip` files for the samples that can be used with IBM Cloud Pak for Data V5.3.x.

The `Cloud Pak for Data v5.2.x` directory contains `.zip` files for the samples that can be used with IBM Cloud Pak for Data V5.2.x.

The `Cloud Pak for Data v5.1.x` directory contains `.zip` files for the samples that can be used with IBM Cloud Pak for Data V5.1.x.

The `Cloud Pak for Data v5.0.x` directory contains `.zip` files for the samples that can be used with IBM Cloud Pak for Data V5.0.x.
