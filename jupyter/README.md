...
- IBM Cloud Pak for Data V5.4.x, V5.3.x, V5.2.x, V5.1.x, V5.0.x, V4.8.x, V4.7.x, V4.6.x, V4.5.x and V4.0.x
...
The `Cloud Pak for Data v5.4.x` directory contains `.ipynb` files for the samples that can be used with IBM Cloud Pak for Data V5.4.x.

The `Cloud Pak for Data v5.3.x` directory contains `.ipynb` files for the samples that can be used with IBM Cloud Pak for Data V5.3.x.

The `Cloud Pak for Data v5.2.x` directory contains `.ipynb` files for the samples that can be used with IBM Cloud Pak for Data V5.2.x.

The `Cloud Pak for Data v5.1.x` directory contains `.ipynb` files for the samples that can be used with IBM Cloud Pak for Data V5.1.x.

The `Cloud Pak for Data v5.0.x` directory contains `.ipynb` files for the samples that can be used with IBM Cloud Pak for Data V5.0.x.
